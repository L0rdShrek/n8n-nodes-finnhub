		...
		options: [
			{
				...
				description: 'Get a list of index\'s constituents. A list of supported indices for this endpoint can be found <a href="https://docs.google.com/spreadsheets/d/1Syr2eLielHWsorxkDEZXyc55d6bNx1M3ZeI4vdn7Qzo/edit?usp=sharing">here</a>.',
			...
			},
			{
				...
				description: 'Get full history of index\'s constituents including symbols and dates of joining and leaving the Index. Currently support ^GSPC, ^NDX, ^DJI.',
				action: 'Lookup for symbols',
				routing: {
					request: {
						method: 'GET',
